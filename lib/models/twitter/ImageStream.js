...
ImageStream.prototype.stop = function () { this.stream.stop.apply(this.stream, arguments); };
ImageStream.prototype.start = function () { this.stream.start.apply(this.stream, arguments); };
